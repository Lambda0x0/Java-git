...
class Bottiglia<T> { // T: parametro generico, destinato a diventare Acqua oppure Vino, o altre eventuali classi, come ArrayList<String>, ArrayList<Camicia>, ecc...
...
class BraccioMeccanico {
    ...
    public void prendiBottiglia(Bottiglia<?> bottiglia) { // ?: il braccio meccanico ignora il contenuto, ma Bottiglia è classe Generics e va scritta con il tipo in <>
...
public class GenericsTest {
    ...
    public static void main(String[] args) {
        ...
        Bottiglia<Vino> bottiglia2 = new Bottiglia<Vino>(new Vino()); // new Vino() è la t che va nel costruttore
        ...
        braccio.prendiBottiglia(bottiglia2); // bottiglia2 è una bottiglia contenente vino
    }

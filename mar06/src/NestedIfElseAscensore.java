public class NestedIfElseAscensore {
    ...
    public void vaiSu() {
        ...
        if (pianoCorrente == PIANO_MAX) { // se sono in cima al palazzo
            System.out.println("Non posso salire!");
        } else { // a un piano qualsiasi

            if (portaAperta) { // controllo se la porta è aperta, if annidato
                chiudiPorta();
            }
    ...
    public void vaiGiu() {
        ...
        if (pianoCorrente == PIANO_MIN) { // se sono al piano terra
